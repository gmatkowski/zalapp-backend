...
export function AuthMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var unauthorizedResponse, bearer, parts, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    unauthorizedResponse = function (res) {
                    ...
                    if (!req.headers['authorization']) {
                        return [2 /*return*/, unauthorizedResponse(res)];
                    }
                    ...
                    return [4 /*yield*/, userService.getUserFromToken(parts[1])];
                case 1:
                    user = _a.sent();
                    if (!user) {
                        return [2 /*return*/, unauthorizedResponse(res)];
